...
class PackageCodecTest {
    ...
    static void  init(){
        ...
        Message m1=new Message(1,11,System.currentTimeMillis(),1111,111111,"this is test",false);
        Message m2=new Message(2,11,System.currentTimeMillis(),2222,222222,"this is test 1",true);
        messageList.add(m1);
        messageList.add(m2);
